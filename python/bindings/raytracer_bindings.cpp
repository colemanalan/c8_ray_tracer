...
public:
    ...
    std::vector<SignalPath> GetSignalPathsNGD(
        const Point &start,
        const Point &end,
    ...
    std::vector<SignalPath> GetSignalPathsBrent(
        const Point &start,
        const Point &end,
        const EnvironmentBase &env) override
    {
...
void bind_raytracer(py::module_ &m)
{
    ...
    py::class_<RayTracerBase, PyRayTracerBase>(tracer, "RayTracerBase")
        ...
        .def("GetSignalPathsNGD", &c8_tracer::RayTracerBase::GetSignalPathsNGD)
        .def("FindEmitAndReceive", &c8_tracer::RayTracerBase::FindEmitAndReceive)
        .def("GetSignalPath", &c8_tracer::RayTracerBase::GetSignalPath)
        .def("GetSignalPathsBrent", &c8_tracer::RayTracerBase::GetSignalPathsBrent)
