...
void bind_path(py::module_ &m)
{
     ...
     py::class_<SignalPath, Path>(path, "SignalPath")
         ...
         .def_readwrite("R_distance", &SignalPath::R_distance_)
         .def_readwrite("fresnelS", &SignalPath::fresnelS_)
         .def_readwrite("fresnelP", &SignalPath::fresnelP_)
         .def_readwrite("emit", &SignalPath::emit_)
         .def_readwrite("receive", &SignalPath::receive_)
